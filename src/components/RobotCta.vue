          ...
          <div class="">
            <div class="robot">
              ...
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 800">
                ...
                <g id="head">
                  <g id="face">
                    <linearGradient id="gold-horizontal" x2="1" y2="1" >
                    ...
                    <path id="screen" style="fill: url(#gold-horizontal) #f0d01e;" d="M164.381,353.965c0,55.225,107.043,76.693,135.619,76.693
                  ...
                  <g id="indicators">
                    ...
                    <g id="leds">
                      ...
                      <circle id="green" fill="#4EBA64" cx="275.33" cy="206" r="8.083">
                        <animate attributeName="fill" dur="500ms" from="#4EBA64" to="#fff" repeatCount="indefinite" />
                      </circle>
                    </g>
                  </g>
                </g>
