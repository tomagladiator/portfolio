...
!(function (t) {
    ...
    l = (function() {
            ...
            return a(t, [{
                ...
                value: function() {
                    this.gl;
                    ! function(t, e) {
                        for (var i = [], a = t.length, n = function() {
                                0 === --a && e(i)
                            }, o = 0; o < a; ++o) {
                            var r = c(t[o], n);
                            i.push(r)
                ...
                value: function(t) {
                    var e = this.gl;
                    this.imageAspect = t[0].naturalHeight / t[0].naturalWidth, console.log(this.imageAspect, "=aspect", this);
  ...
  e.default = l, h.prototype.set = function () {
    for (var t = 'uniform' + this.suffix, e = arguments.length, i = Array(e), a = 0; a < e; a++) i[a] = arguments[a]
  ...
  var a, n
    ...
    !(function(t) {
        ...
        function n(t) {
            for (var e in u.orientation.data = t, u.orientation.callbacks) u.orientation.callbacks[e].call(this)
        }

        function o(t) {
            for (var e in u.motion.data = t, u.motion.callbacks) u.motion.callbacks[e].call(this)
        }
        if (void 0 === t.FULLTILT || null === t.FULLTILT) {
            ...
            y.Quaternion.prototype = {
                ...
                multiplyMatrices: function() {
                    var t, e, i = new y.RotationMatrix;
                    return function(a, n) {
                ...
                this.set = function(t, e, i) {
                    ...
                    return function(a) {
                        var n = a.w * a.w,
                            ...
                            m = n + o + c + u,
                            d = a.w * a.x + a.y * a.z;
                        if (d > .499999 * m) t = 2 * Math.atan2(a.y, a.w), e = s, i = 0;
                        else if ((1e-6 - .5) * m > d) t = -2 * Math.atan2(a.y, a.w), e = -s, i = 0;
                        else {
                            var v = n - o + c - u,
                                g = 2 * (a.w * a.z - a.x * a.y),
                                f = n - o - c + u,
